...
служба; центр; источник; администрация; ответственная организация; ведомство
...
Обратный (оборотный) прокси-сервер — это прокси-сервер, ретранслирующий запросы клиентов из внешней сети на сервера внутренней сети.
