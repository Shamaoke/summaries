...
[Свойства контейнеров](#Свойства_контейнеров)
...
[Ссылка на образ](#Ссылка_на_образ)
...
* Скачать образ из удаленного репозитория (`hub.docker.com` по умолчанию), если
...
## Перечень Инструкций ##
{: id="Dockerfile-Перечень_инструкций" }
