...
_не добавлять указанные файлы и каталоги в архив при эксторте с помощью_ **`git
archive`**
...
Файл должен содержаться в текущей ветви.

**`git rm --cached`** _`file`_

_выставить файл для удаления и одновременно создать новую копию файла с тем же
самым именем_

В данном случае, будет создано два файла: один, предназначенный для удаления, в
индексе и один новый в рабочем пространстве.
