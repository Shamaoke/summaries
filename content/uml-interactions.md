...
Меркер времени — элемент диаграммы в виде короткой горизонтальной черты, перпендикулярной временной оси.
...
элемент диаграммы, описывающий временной промежуток, в течении которого может происходить некий процесс

**локальный атрибут**

элемент диаграммы, используемый для спецификации переменных и аргументов
...
элемент диаграммы, обозначающий момент времени на временной оси (на „линии жизни“)
