...
: * Установить минимально допустимую версию системы CMake, используемую для
  ...
  * Установить поведение текущей версии CMake в соответствие с поведением
    ...
    В случае попытки сборки проекта системой CMake более ранней версии,
    возникнет исключительная ситуация, которая приведет к завершению процесса
    генерирования файлов сборки.
...
: * Установить имя проекта (`sample`)
  ...
  * Установить используемые языки программирования (`CXX` — С++)
    ...
    ситуация, которая приведет к завершению процесса генерирования файлов сборки.
